                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <AlertDescription className="text-sm text-blue-700">
                      Importing this project will create a copy for you to use
                      and modify.
                    </AlertDescription>
                  </Alert>

                  <p className="text-sm text-muted-foreground">
                    The imported project will include all flashcards but you'll
                    be able to modify them independently.
                  </p>
                </div>
              )}
